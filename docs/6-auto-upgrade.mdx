...
```bash
curl -L -o depai_auto_upgrade.sh https://depai.online/downloads/depai_auto_upgrade.sh && echo -e "\nDownloaded depai_auto_upgrade.sh"
curl -L -o nohup_run_depai.sh https://depai.online/downloads/nohup_run_depai.sh && echo -e "\nDownloaded nohup_run_depai.sh"
```
